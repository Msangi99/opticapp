              ...
              child: ListView(
                ...
                children: [
                  ...
                  _DrawerSectionCard(
                    ...
                    primary: primary,
                    items: [
                      _NavItem(icon: Icons.category_rounded, label: 'Brands', route: '/admin/categories'),
                      _NavItem(icon: Icons.view_in_ar_rounded, label: 'Models', route: '/admin/models'),
                      _NavItem(
                      ...
                      _NavItem(icon: Icons.map_rounded, label: 'Regional managers', route: '/admin/regional-managers'),
                      _NavItem(icon: Icons.groups_rounded, label: 'Team leaders', route: '/admin/team-leaders'),
                      _NavItem(icon: Icons.admin_panel_settings_rounded, label: 'Leaders', route: '/admin/subadmins'),
                      _NavItem(icon: Icons.account_tree_rounded, label: 'Organization', route: '/admin/organization'),
                    ],
                    onNavigate: navigate,
                  ),
                  const SizedBox(height: _sectionSpacing),
                  _DrawerSectionCard(
                    ...
                    items: [
                      ...
                      _NavItem(icon: Icons.swap_horiz_rounded, label: 'Passthrough', route: '/admin/passthrough'),
                      _NavItem(icon: Icons.local_shipping_rounded, label: 'Distribution', route: '/admin/stock/distribution'),
                      _NavItem(icon: Icons.credit_card_rounded, label: 'Agent credits', route: '/admin/agent-credits'),
                  ...
                  _DrawerSectionCard(
                    ...
                    items: const [
                      ...
                      _NavItem(icon: Icons.request_quote_rounded, label: 'Payables', route: '/admin/payables'),
                      ...
                      _NavItem(icon: Icons.business_rounded, label: 'Vendor profile', route: '/admin/vendor-profile'),
                      _NavItem(icon: Icons.settings_rounded, label: 'Settings', route: '/admin/settings'),
                      _NavItem(icon: Icons.person_outline_rounded, label: 'Profile', route: '/admin/profile'),
                    ],
                    onNavigate: navigate,
                  ),
                ],
